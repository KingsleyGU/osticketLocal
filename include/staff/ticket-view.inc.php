...
?>
    ...
    <?php
     ...
     <div id="responza-Knowledge" class="tab-response-block">
        <iframe  id="responza-iframe" src="http://supportkb.spitzeco.dk//contentkb/1_1/1/1/Search?customer=Erhvervsstyrelse&title=1_1&page=1&sparam=<?php echo urlencode(Format::htmlchars($ticket->getSubject())); ?>">
        </iframe>
     </div>
</div>
